...
| [**Fail2Ban**](https://github.com/fail2ban/fail2ban)   | Provides protection against brute force and authentication attempts  |
| [**Certbot SSL**](https://certbot.eff.org/)   | Is used to obtain HTTPS/TLS/SSL certificates  |
